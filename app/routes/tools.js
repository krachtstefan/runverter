...
export default Route.extend({
  ...
  model: function(params) {
    ...
    var run = this.store
      ...
      .then(function(run) {
        self.store.findRecord('run', 'achievedRun').then(
          function(achievedRun) {
      ...
      .then(function(run) {
        self.store.findRecord('splits', 'splits').then(
          function(splits) {
    ...
    var settings = this.store.findRecord('settings', 'settings').then(
      function(settings) {
        return settings;
      },
      function() {
