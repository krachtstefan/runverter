export default {
  ...
  tools: {
    ...
    pc: {
      ...
      description:
        'There a lots of ways to define a tempo. Here you have all in one place.',
  ...
  flashMessages: {
    peterRiegelExlanation:
      'Please note that the race prediction is only suitable if both races are lasting between 3.5 minutes and 3 hours, 50 minutes.',
    releaseNotesDarkmode:
      'Hey, you! Runverter has a dark theme now &#9790;<br />Go check out the settings.<br /><br />love Stefan',
